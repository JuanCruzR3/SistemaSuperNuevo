...
namespace CapaDatos
{
    public class CD_Compra
    {
        ...
        // ==========================================================
        // ✅ LISTAR COMPRAS PARA ANULAR (SP: sp_ListarComprasParaAnular)
        // ==========================================================
        public List<Compra> ListarParaAnular()
        {
            ...
            using (SqlConnection cn = new SqlConnection(Conexion.cadena))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("sp_ListarComprasParaAnular", cn);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        // ==========================================================
        // ✅ ANULAR COMPRA (SP: sp_AnularCompra)
        // ==========================================================
        public bool AnularCompra(int idCompra, out string mensaje)
        {
            ...
            using (SqlConnection cn = new SqlConnection(Conexion.cadena))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("sp_AnularCompra", cn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@IdCompra", idCompra);

                    // Si tu SP devuelve OUTPUTs, esto lo aprovecha.
